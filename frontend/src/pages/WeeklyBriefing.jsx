          ...
          {data.sectors.map((s) => {
            ...
            return (
              <Grid size={{ xs: 12, sm: 4 }} key={s.name}>
                <Card sx={{
                  borderColor: isStrong ? 'rgba(76,175,80,0.2)' : isWeak ? 'rgba(244,67,54,0.15)' : 'rgba(255,255,255,0.08)',
                }}>
            ...
            <Grid size={{ xs: 12, sm: 4 }} key={s.symbol}>
              ...
              >
                <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
                  ...
                  <Chip label={s.sector} size="small" sx={{ height: 20, fontSize: '0.65rem', mr: 0.5, bgcolor: 'rgba(255,255,255,0.06)' }} />
        ...
        <CardContent sx={{ p: 2, '&:last-child': { pb: 2 } }}>
          <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', flexWrap: 'wrap', gap: 1 }}>
            <Box sx={{ display: 'flex', gap: 1 }}>
              ...
              <Button variant="outlined" onClick={() => navigate('/scanner')}>View All Signals</Button>
              <Button variant="outlined" onClick={() => navigate('/portfolio')}>Review Portfolio</Button>
            </Box>
            <Box sx={{ display: 'flex', gap: 1 }}>
              <Chip icon={<WhatsApp sx={{ fontSize: '0.9rem' }} />} label="WhatsApp" size="small" variant="outlined" sx={{ borderColor: 'rgba(255,255,255,0.1)' }} />
              <Chip icon={<Email sx={{ fontSize: '0.9rem' }} />} label="Email" size="small" variant="outlined" sx={{ borderColor: 'rgba(255,255,255,0.1)' }} />
            </Box>
          </Box>
